...
const Board = lazyWithReload(() => import("@/pages/custom/Board"));
const KnowledgeGraph = lazyWithReload(() => import("@/pages/custom/KnowledgeGraph"));
const NocoDB = lazyWithReload(() => import("@/pages/custom/NocoDB"));
const N8n = lazyWithReload(() => import("@/pages/custom/N8n"));
const QuestTimeline = lazyWithReload(() => import("@/pages/custom/QuestTimeline"));
const TagManager = lazyWithReload(() => import("@/pages/custom/TagManager"));
const AssetManager = lazyWithReload(() => import("@/pages/custom/AssetManager"));
